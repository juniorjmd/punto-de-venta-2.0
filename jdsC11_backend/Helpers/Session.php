...
class Session {
    ...
    /**
     * Crea un id de transacción basado en fecha, hora y usuario 
     * @return string Id de la transacción
     */
    public static function createIdTransac() {
        $id_transac = Date::getDateInLine() . ':' . Session::get('userBD'); //Tiempo:NombredeUsuario
        Session::set($id_transac, 'created'); //Con el propósito de crear y monitorear transacciones (nombre, estado)
        return $id_transac;
    }
